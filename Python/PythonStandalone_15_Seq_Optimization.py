...
if __name__ == '__main__':
    ...
    if not os.path.exists(zosapi.TheApplication.SamplesDir + "\\API\\Python\\e15_Seq_Optimization"):
        os.makedirs(zosapi.TheApplication.SamplesDir + "\\API\\Python\\e15_Seq_Optimization")
    ...
    if os.path.isfile(zosapi.TheApplication.SamplesDir + '\\Short course\\sc_dbga1.zmx'):
        ...
        TheSystem.LoadFile(zosapi.TheApplication.SamplesDir + '\\Short course\\Optical System Design Using OpticStudio\\sc_dbga1.zmx', False)
    ...
    if (GlobalOpt != None):
        GlobalOpt.Algorithm = constants.OptimizationAlgorithm_DampedLeastSquares
    ...
    if (HammerOpt != None):
        HammerOpt.Algorithm = constants.OptimizationAlgorithm_DampedLeastSquares
